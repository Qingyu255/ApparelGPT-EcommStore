...
export default function Home({products, posts}) {
  const {setNonCustomProductsNew} = useContext(ProductsContext)
  ...
  return (
    <Layout>
      <Banner />
      <Featured />
      <div className="mb-10 border-t-2 mx-5 sm:mx-10 ">
        {categoriesNames.map(categoryName => (
          <div key={categoryName}>
            ...
            <div className="flex overflow-x-auto snap-x pb-3 gap-5">
