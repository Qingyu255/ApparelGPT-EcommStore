...
export default function Footer() {
    ...
    return (
        <footer className="sticky bottom-0 bg-white p-3 w-full text-gray-500 flex justify-center border-t space-x-16">
            <Link href={"/"}>
                <div className={(path === "/"? "text-gray-900" : "hover:text-gray-700")}>
            ...
            <Link href={"/checkout"}>
                <div className={(path === "/checkout"? "text-gray-900" : "hover:text-gray-700")}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-2.5">
