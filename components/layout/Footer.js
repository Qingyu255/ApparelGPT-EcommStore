...
export default function Footer() {
    ...
    return (
        <div className="fixed bottom-0 bg-white py-2 pb-1 w-full text-gray-500 flex justify-center border-t border-[#222629] space-x-16 z-50">
            <Link href={"/"}>
                <div className={(path === "/"? "text-[#222629]" : "hover:text-gray-700")}>
            ...
            <Link href={"/checkout"}>
                <div className={(path === "/checkout"? "text-[#222629]" : "hover:text-gray-700")}>
                    ...
                    <span>Bag {selectedProducts.length + selectedCustomProducts.length}</span>
                </div>
            </Link>      
        </div>
    )
